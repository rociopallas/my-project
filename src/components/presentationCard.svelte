<script>
  import Laura from "../asset/Laura.jpg";
  import Aldo from "../asset/Aldo.jpg";
  import Luisina from "../asset/Luisina.jpg";
  import Gonzalo from "../asset/Gonzalo.jpg";
  import Rocio from "../asset/Rocio.jpg";
  ...
  let team = [
    ...
    },
    {
      ...
      linkedin:
        "https://www.linkedin.com/in/aldo-daniel-s%C3%A1nchez-gonz%C3%A1lez-3a604b280/",
    },
    {
      image: Luisina,
...
<section class="container p-10 md:py-20 px-0 md:p-20 md:px-0 antialiased">
  <section class="grid lg:grid-cols-5 gap-6">
    {#each team as member (member.name)}
      <article
        class="max-w-sm bg-cover bg-center min-h-150 transform duration-500 hover:-translate-y-2 cursor-pointer group"
        style="background-image: url({member.image})"
      >
        <div
          class="bg-black bg-cover bg-opacity-10 min-h-150 px-10 py-10 flex flex-wrap flex-col pt-96 hover:bg-opacity-10 transform duration-300"
        >
          <h1
          ...
          <div
            class="w-16 h-2 bg-my_violet rounded-full mb-5 transform translate-y-20 group-hover:translate-y-0 duration-300"
          />
          <p
            class="opacity-0 text-white group-hover:opacity-80 transform duration-500 text-base"
          >
            {member.role}
          </p>
          <div
            class="mt-4 flex space-x-2 opacity-0 group-hover:opacity-100 transform duration-500"
          >
